...
clear @p jedy:arma_shisui
give @p jedy:voar 1
replaceitem entity @p slot.weapon.mainhand 1 jedy:arma_shisui
replaceitem entity @p slot.armor.head 1 jedy:susanoo_sh4

effect @p health_boost 300 36 true
effect @p strength 300 5 true 
effect @p speed 300 6 true
effect @p jump_boost 300 7 true
effect @p resistance 300 4 true 
effect @s instant_health 1 255 true
tellraw @p{"rawtext":[{"text":"§l§c==Susanoo Shisui Forma 4=="}]}
tellraw @p{"rawtext":[{"text":"§lAtaque:§l§a+5"}]}
tellraw @p{"rawtext":[{"text":"§lVida: §l§a+36"}]}
tellwssraw @p{"rawtext":[{"text":"§lRegen: §l§a+3"}]}
