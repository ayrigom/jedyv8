...
replaceitem entity @p slot.weapon.mainhand 1 jedy:arma_4son
give @p jedy:yoton
give @p jedy:yoton2
replaceitem entity @p slot.armor.head 1 jedy:barion_songoku
...
tellraw @p{"rawtext":[{"text":"§l§4==Baryon Son Goku=="}]}
