...
replaceitem entity @p slot.weapon.mainhand 1 jedy:em_itachiz
...
replaceitem entity @p slot.armor.head 1 jedy:em_itachi 1 0 {"item_lock":{"mode":"lock_in_slot"}}
...
tellraw @p{"rawtext":[{"text":"§l§c==Mangekyo Itachi Edo=="}]}
